...
import { skills, skillCategories, type Skill } from '../../content/skills'; // Pas het pad aan
...
const SkillGalaxy: React.FC = () => {
  ...
  // Bereken posities voor alle skills
      ...
      <div className="skillGalaxyContainer">
        ...
        <div className="filterContainer">
          <button
            ...
            style={activeCategory === 'all' ? { background: getCategoryColor('all') } : {}}
          >
            All
          </button>
          {skillCategories.map(category => (
            <motion.button
              ...
              style={activeCategory === category.id ? { background: getCategoryColor(category.id) } : {}}
          ...
          <AnimatePresence>
            {selectedSkill && (
              ...
              >
                ...
                <button className="closeButton" onClick={() => setSelectedSkill(null)}>
                  Close
                </button>
              </motion.div>
            )}
